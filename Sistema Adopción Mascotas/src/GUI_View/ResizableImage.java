...
/**
 *Clase extraída con propósitos de utilidad del usuario MadProgrammer. Publicada el 27/01/2013 y extraída el 5 Abril, 2015
 * Publicada en http://stackoverflow.com/questions/14548808/scale-the-imageicon-automatically-to-label-size.
...
public class ResizableImage {
        ...
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    frame.add(new ScalablePanel(image));
                    frame.pack();
    ...
    public class ScalablePanel extends JPanel {
        ...
        public ScalablePanel(Image master) {
            this(master, true);
        }

        public ScalablePanel(Image master, boolean toFit) {
            this.master = master;
            setToFit(toFit);
        }
