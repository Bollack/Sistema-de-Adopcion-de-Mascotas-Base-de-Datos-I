...
/*
    Clase publicada por Rob Camick el 19 de Marzo del 2009 y abierta a la utilización de cualquier persona y/o grupo.
    Todos los créditos y agradecimientos al usuario creador.
    Publicada  en https://tips4java.wordpress.com/2009/03/12/table-from-database/ 
*/

/*
    Clase utilizada, junto con ListTableModel, para exportar y crear de manera sencilla un objeto de clase ResultSet a un modelo
    de una jTable. En palabras más simples, transforma el resultado dado de una consulta a la DB a un modelo útil para implementar en una tabla
    de Swing. 
*/
